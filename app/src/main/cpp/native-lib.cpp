...
extern "C"
JNIEXPORT void Java_com_vesoontech_ui_myapplication_NativeBlurProcess_functionToBlur(JNIEnv* env, jclass clzz, jobject bitmapOut, jint radius, jint threadCount, jint threadIndex, jint round) {
    // Properties
